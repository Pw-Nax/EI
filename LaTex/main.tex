...
\noindent
donde $n$ es la relación de transformación, $L$ es la inductancia serie, $f_s$ es la frecuencia de conmutación y $D$ es el duty cycle. A partir de esto, se obtiene la potencia transmitida como
