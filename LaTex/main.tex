...
Los dos puentes son controlados de tal forma que generen una onda cuadrada de tensión en ambos lados del transformador, pero el principio de funcionamiento se basa en el desfasaje entre las dos ondas. La diferencia entre estas dos tensiones cae en la inductancia propia de los devanados del transformador, resultando en una corriente que circula en ambos puentes y produce la transferencia de potencia. Esta inductancia se modela como un inductor en serie con el transformador y en la implementación también suele ser complementada con otro inductor para obtener la potencia máxima requerida.
...
Las formas de onda se muestran en la figura \ref{fig:graf_dab_teo}. Los dos puentes conmutan con un duty cycle del 50\% pero desfasados un ángulo $\phi$. Esto genera una corriente sobre la inductancia que es posible calcular mediante la ley de Faraday-Lenz. La corriente promedio en la etapa de salida es
...
\begin{equation}
    P_o = \frac{V_i V_o}{2 n L f_s}\, D(1-D)
\end{equation}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Imagenes/graf_dab_teo.png}
