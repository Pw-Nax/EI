...
En este trabajo final integrador se propuso señalar los conceptos fundamentales del DAB y sus formas de onda, posteriormente seleccionar todos los componentes necesarios según las siguientes especificaciones:
...
\noindent
Finalmente se simulara el circuito y comparara el resultado obtenido con la expectativa teórica.
...
\begin{figure}[H]
    ...
    \caption{Diagrama del convertidor de doble puente activo (DAB).}
    \label{fig:circuito}
\end{figure}
